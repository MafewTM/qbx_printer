...
-- Open document event
RegisterNetEvent(
    "qbx_printer:client:useDocument",
    function(data)
...
-- Start printer event
RegisterNetEvent(
    "qbx_printer:client:startPrinter",
    function()
...
-- Spawn printer event
RegisterNetEvent(
    "qbx_printer:client:spawnPrinter",
    function()
        CreateThread(
            function()
                ...
                local previewObject = CreateObject(model, pos.x, pos.y, pos.z, true, false, false)
